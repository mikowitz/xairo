defmodule Xairo.LinearGradientTest do
  ...
  alias Xairo.{LinearGradient, Point, Rgba}

  doctest LinearGradient

  describe "new/4" do
    test "returns a LinearGradient struct" do
      gradient = LinearGradient.new(Point.new(10, 10), Point.new(75, 80))
  ...
  describe "linear_points/1" do
    test "returns the bounding points for the gradient" do
      ...
      assert LinearGradient.linear_points(gradient) ==
               {Point.new(10.0, 10.0), Point.new(75.0, 80.0)}
    end
  end

  describe "add_color_stop" do
    gradient =
      LinearGradient.new(Point.new(10, 10), Point.new(75, 80))
